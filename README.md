...
V2Plug TV 是一款专为 **Android TV / 电视盒子** 设计的**开源免费** VPN 客户端，基于 Xray-core 构建。与传统 VPN 应用不同，它采用**零后端依赖**架构，所有配置通过手机端扫码推送，无需在电视上输入复杂信息。
...
本项目由 [V2Plug 打包平台](http://v2borad.haima.lol) 提供技术支持。我们提供：

- 🚀 **一键打包服务** - 无需开发环境，在线生成定制客户端
- 🎨 **品牌定制** - 自定义 LOGO、名称、主题色、启动页
- 📱 **多平台支持** - Windows、Android、Android TV 全平台
- ☁️ **云端构建** - 专业构建服务器，快速稳定
- 💎 **灵活套餐** - 按需选择，性价比高

> 💡 **开源 + 商业的完美结合**：TV 端完全开源供开发者学习和二次开发，同时我们提供专业的打包服务，让非技术用户也能轻松拥有自己的品牌客户端。
